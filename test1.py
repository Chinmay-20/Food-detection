...
def x(path,a):
	...
	fruit_areas,fruit_bin,fruit_final,skin_areas, fruits, pix_cm = calculateFoodArea(image)
	volume = computeVolume(a, fruit_areas, skin_areas, pix_cm, fruits)
	mass, cal, cal100 = computerCalories(a, volume)
	fruit_volumes=volume
	fruit_calories=cal
	fruit_calories_100grams=cal100
	fruit_mass=mass
	print(fruit_calories," calories")
